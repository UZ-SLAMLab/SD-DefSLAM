...
main() { (
    ...
    echo $folder_images_left $folder_images_right $pattern_image_right $pattern_image_left $leftCalibration $rightCalibration $extrinsicCalibration
    ./build/elasHamlyn $folder_images_left $folder_images_right $pattern_image_right $pattern_image_left $leftCalibration $rightCalibration $extrinsicCalibration
    return 0
); }
