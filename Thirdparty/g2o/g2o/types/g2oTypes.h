...
namespace g2o
{
  ...
  class EdgeNodesLaplace1 : public BaseMultiEdge<1, Eigen::Vector1D>
  {
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeNodesLaplace1() {}
  ...
  class EdgesTemp : public BaseUnaryEdge<3, Eigen::Vector3d, VertexSBAPointXYZ>
  {
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgesTemp() {}
