...
set(VTK_MODULES_DIR "/home/mingo/VTK-8.2.0/build/lib/cmake/vtk-8.2/Modules")
...
set(VTK_CMAKE_DIR "/home/mingo/VTK-8.2.0/CMake")
...
if (__vtk_install_tree)
  ...
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/home/mingo/VTK-8.2.0/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/home/mingo/VTK-8.2.0/build/lib")
  endif ()
endif()
...
# Import VTK targets.
set(VTK_CONFIG_TARGETS_FILE "/home/mingo/VTK-8.2.0/build/VTKTargets.cmake")
if(NOT TARGET vtkCommonCore)
  include("${VTK_CONFIG_TARGETS_FILE}")
endif()

# Load module interface macros.
include("/home/mingo/VTK-8.2.0/CMake/vtkModuleAPI.cmake")
