...
namespace ORB_SLAM2 {
namespace Optimizer {
void GlobalBundleAdjustemnt(Map *pMap, int nIterations, bool *pbStopFlag,
...
int PoseOptimization(Frame *pFrame) {
  ...
  const float chi2Mono[5] = {5.991 * 3, 5.991 * 3, 5.991 * 3, 5.991 * 3,
                             5.991 * 3};
...
int OptimizeSim3(KeyFrame *pKF1, KeyFrame *pKF2, vector<MapPoint *> &vpMatches1,
