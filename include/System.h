...
public:
  ...
  // Using stereo for initialisation
  virtual cv::Mat TrackMonocular(const cv::Mat &im, const cv::Mat &imRight,
                                 const double &timestamp,
                                 const cv::Mat _mask = cv::Mat());
  ...
  virtual cv::Mat TrackMonocularGT(const cv::Mat &im, const cv::Mat &imRight,
                                   const double &timestamp,
                                   const cv::Mat _mask = cv::Mat());
  // Using stereo for depth image the ground truth
  cv::Mat TrackMonocularCTGT(const cv::Mat &im, const cv::Mat &CTdepth,
                             const double &timestamp, const cv::Mat _mask);

  bool RelocateMonocular(const cv::Mat &im, const double &timestamp,
                         const cv::Mat _mask = cv::Mat());
